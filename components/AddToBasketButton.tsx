...
export default function AddToBasketButton({product, disabled}: AddToBasketButtonProps) {
  ...
  return (
    <div className="flex items-center justify-center self-center space-x-2">
      ...
      className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors duration-200 ${disabled ? "bg-gray-400 cursor-not-allowed": "bg-blue-900 hover:bg-blue-950"}`}
      disabled={disabled}
      >
